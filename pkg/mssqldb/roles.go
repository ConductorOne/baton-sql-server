...
`)
	l.Debug("ListServerRolePrincipals", zap.String("sql query", sb.String()))
...
`)
	l.Debug("ListServerRoles", zap.String("sql query", sb.String()))
	rows, err := c.db.QueryxContext(ctx, sb.String(), args...)
	if err != nil {
		return nil, "", err
	}
...
ORDER BY 
  principal_id ASC OFFSET @p1 ROWS FETCH NEXT @p2 ROWS ONLY
`)
	l.Debug("ListDatabaseRoles", zap.String("sql query", sb.String()))
	rows, err := c.db.QueryxContext(ctx, sb.String(), args...)
	if err != nil {
		return nil, "", err
	}
...
func (c *Client) ListDatabaseRolePrincipals(ctx context.Context, dbName string, databaseRoleID string, pager *Pager) ([]*RolePrincipalModel, string, error) {
	...
	l.Debug("ListDatabaseRolePrincipals", zap.String("sql query", query))
